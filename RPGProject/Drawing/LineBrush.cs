...
{// This is not my code. I credit FarseerGames for this. This class draws line objects as textures. I use this in debugging my use of the CollisionBox object to allow the rectangles associated with them to be drawn.
